...
namespace MinaGlosor.Web.Controllers.Api
{
    public class WordListController : ApiControllerBase
    {
        public HttpResponseMessage Get()
        {
            ...
            var wordLists = ExecuteQuery(query);
        ...
        {
            var wordList = ExecuteQuery(new GetWordListByIdQuery(id));
        ...
        public HttpResponseMessage Post(CreateWordListRequest request)
        {
            ...
            ExecuteCommand(new CreateWordListCommand(request.WordListName, CurrentUser));
